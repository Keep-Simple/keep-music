...
export type CreateAlbumMutation = { __typename?: 'Mutation' } & {
    createAlbum: { __typename?: 'Album' } & Pick<
        Album,
        'id' | 'name' | 'cover' | 'releaseYear' | 'tracksNumber'
    > & {
            songs?: Maybe<
                Array<
...
export type CreateAuthorMutation = { __typename?: 'Mutation' } & {
    createAuthor: { __typename?: 'Author' } & Pick<
        Author,
        'id' | 'name' | 'info' | 'avatar' | 'photos'
    >
}
...
export type ViewSongMutation = { __typename?: 'Mutation' } & Pick<
    Mutation,
    'viewSong'
>
...
export type AlbumQuery = { __typename?: 'Query' } & {
    album?: Maybe<
        { __typename?: 'Album' } & Pick<
            Album,
            'id' | 'name' | 'tracksNumber' | 'cover' | 'releaseYear'
        > & {
                author: { __typename?: 'Author' } & Pick<Author, 'id' | 'name'>
                songs?: Maybe<
                    Array<
...
export type AlbumsQuery = { __typename?: 'Query' } & {
    albums?: Maybe<
        Array<
            { __typename?: 'Album' } & Pick<
                Album,
                'id' | 'name' | 'cover' | 'releaseYear'
            > & {
...
export type AuthorsQuery = { __typename?: 'Query' } & {
    authors?: Maybe<
        Array<
            { __typename?: 'Author' } & Pick<Author, 'id' | 'name' | 'avatar'>
        >
    >
}
...
export function useCreateAuthorMutation(
    ...
    return Apollo.useMutation<
        CreateAuthorMutation,
        CreateAuthorMutationVariables
    >(CreateAuthorDocument, baseOptions)
}
...
`
export type ViewSongMutationFn = Apollo.MutationFunction<
    ViewSongMutation,
 ...
 * });
 */
export function useViewSongMutation(
    baseOptions?: Apollo.MutationHookOptions<
        ViewSongMutation,
        ViewSongMutationVariables
    >
) {
    return Apollo.useMutation<ViewSongMutation, ViewSongMutationVariables>(
        ViewSongDocument,
        baseOptions
    )
}
...
export type ViewSongMutationOptions = Apollo.BaseMutationOptions<
    ViewSongMutation,
    ViewSongMutationVariables
>
...
export function useAuthorsQuery(
    baseOptions?: Apollo.QueryHookOptions<AuthorsQuery, AuthorsQueryVariables>
) {
    return Apollo.useQuery<AuthorsQuery, AuthorsQueryVariables>(
        AuthorsDocument,
        baseOptions
    )
}
export function useAuthorsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<
        AuthorsQuery,
        AuthorsQueryVariables
    >
) {
    return Apollo.useLazyQuery<AuthorsQuery, AuthorsQueryVariables>(
        AuthorsDocument,
        baseOptions
    )
}
...
export type AuthorsQueryResult = Apollo.QueryResult<
    AuthorsQuery,
    AuthorsQueryVariables
>
