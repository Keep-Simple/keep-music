...
export type AlbumKeySpecifier = ('id' | 'tracksNumber' | 'cover' | 'name' | 'info' | 'realeaseDate' | 'authorId' | 'author' | 'songs' | AlbumKeySpecifier)[];
export type AlbumFieldPolicy = {
	...
	name?: FieldPolicy<any> | FieldReadFunction<any>,
	info?: FieldPolicy<any> | FieldReadFunction<any>,
	realeaseDate?: FieldPolicy<any> | FieldReadFunction<any>,
	authorId?: FieldPolicy<any> | FieldReadFunction<any>,
	author?: FieldPolicy<any> | FieldReadFunction<any>,
	songs?: FieldPolicy<any> | FieldReadFunction<any>
};
export type SongKeySpecifier = ('id' | 'name' | 'link' | 'byteSize' | 'cover' | 'duration' | 'views' | 'order' | 'quality' | 'albumId' | 'authorId' | SongKeySpecifier)[];
...
export type QueryKeySpecifier = ('song' | 'album' | 'albums' | 'author' | 'me' | QueryKeySpecifier)[];
